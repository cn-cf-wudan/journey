...
_be.bb.refresh.linkbutton({iconCls:(_bf.loading?"pagination-loading":"fa fa-undo")});
}
};
...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"Displaying {from} to {to} of {total} items",nav:{first:{iconCls:"fa fa-angle-double-left",handler:function(){
var _ce=$(this).pagination("options");
if(_ce.pageNumber>1){
$(this).pagination("select",1);
}
}},prev:{iconCls:"fa fa-angle-left",handler:function(){
var _cf=$(this).pagination("options");
if(_cf.pageNumber>1){
$(this).pagination("select",_cf.pageNumber-1);
}
}},next:{iconCls:"fa fa-angle-right",handler:function(){
...
}},last:{iconCls:"fa fa-angle-double-right",handler:function(){
...
$("<div class=\"tabs-header\">"+"<div class=\"tabs-scroller-left icon\" data-icon=\"&#xe018;\" ></div>"+"<div class=\"tabs-scroller-right icon\" data-icon=\"&#xe015;\" ></div>"+"<div class=\"tabs-wrap\">"+"<ul class=\"tabs\"></ul>"+"</div>"+"</div>").prependTo(_32c);
...
$("<a href=\"javascript:void(0)\" class=\"tabs-close\"><i class=\"fa fa-times\"></i></a>").appendTo(tab);
}else{
