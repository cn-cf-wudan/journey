...
/**
 * @author wudan-mac
 * @ClassName: RedisDaoImplSingle
 * @ClassNameExplain: 单节点redisDao实现类
 * @Description:
 * @date 16/5/18 下午6:19
 */
public class RedisDaoImplSingle implements IRedisDao {

    private int maxRedirections;

    private JedisSingleConnectionHandler connectionHandler;

    public RedisDaoImplSingle(JedisPool jedisPool, int maxRedirections) {
        this.connectionHandler = new JedisSingleConnectionHandler(jedisPool);
        this.maxRedirections = maxRedirections;
    }

    public void close() throws IOException {
        if (this.connectionHandler != null && this.connectionHandler.getJedisPool() != null) {
            connectionHandler.getJedisPool().destroy();
        }
    }
    ...
    public String set(String key, String value) {
        return (String) (new JedisSingleCommand(this.connectionHandler, this.maxRedirections) {
            @Override
    ...
    public Boolean exists(String key) {
        return (Boolean) (new JedisSingleCommand(this.connectionHandler, this.maxRedirections) {
            @Override
    ...
    public Long persist(String key) {
        return (Long) (new JedisSingleCommand(this.connectionHandler, this.maxRedirections) {
            @Override
    ...
    public Double incrByFloat(String key, double value) {
        return (Double) (new JedisSingleCommand(this.connectionHandler, this.maxRedirections) {
            @Override
    ...
    public List<String> hmget(String key, String... fields) {
        return (List<String>) (new JedisSingleCommand(this.connectionHandler, this.maxRedirections) {
            @Override
    ...
    public Set<String> hkeys(String key) {
        return (Set<String>) (new JedisSingleCommand(this.connectionHandler, this.maxRedirections) {
            @Override
    ...
    public Map<String, String> hgetAll(String key) {
        return (Map<String, String>) (new JedisSingleCommand(this.connectionHandler, this.maxRedirections) {
            @Override
    ...
    public Set<Tuple> zrangeWithScores(String key, long start, long end) {
        return (Set<Tuple>) (new JedisSingleCommand(this.connectionHandler, this.maxRedirections) {
            @Override
    ...
    public ScanResult<Map.Entry<String, String>> hscan(String key, int cursor) {
        return (ScanResult<Map.Entry<String, String>>) (new JedisSingleCommand(this.connectionHandler, this.maxRedirections) {
            @Override
    ...
    public ScanResult<String> sscan(String key, int cursor) {
        return (ScanResult<String>) (new JedisSingleCommand(this.connectionHandler, this.maxRedirections) {
            @Override
    ...
    public ScanResult<Tuple> zscan(String key, int cursor) {
        return (ScanResult<Tuple>) (new JedisSingleCommand(this.connectionHandler, this.maxRedirections) {
            @Override
    ...
    public List<GeoCoordinate> geopos(String key, String... members) {
        return (List<GeoCoordinate>) (new JedisSingleCommand(this.connectionHandler, this.maxRedirections) {
            @Override
    ...
    public List<GeoRadiusResponse> georadius(String key, double longitude, double latitude, double radius, GeoUnit unit) {
        return (List<GeoRadiusResponse>) (new JedisSingleCommand(this.connectionHandler, this.maxRedirections) {
            @Override
